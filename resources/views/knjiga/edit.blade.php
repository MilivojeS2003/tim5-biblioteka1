...
<section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="scroll height-content section-content">
                <form action="{{route('knjiga.update',$knjiga->id)}}" enctype="multipart/form-data"  method="post" class="text-gray-700 forma">
                    @csrf
                    @method('PUT')
                    ...
                    <div x-data="dropdown()" x-init="loadOptionsEdit()" class="flex flex-col w-[90%]">
                        <input name="kategorije" id="kategorijaInputEdit" type="hidden" x-bind:value="selectedValues()">
                ...
                <div class="fail" id="validateNazivKnjiga">
                        ...
                        <div class="mt-[20px]">
                    <p>Izaberite zanr <span class="text-red-500">*</span></p>
                    <!---------------x-cloak  ------------>
            ...
            <div class="mt-[20px]">
                ...
                <select x-cloak
                    ...
                    <option
                    @php if($knjiga->izdavac->id==$izdavac->id){ echo 'selected';
                    } @endphp
                     value="{{$izdavac->id}}">
                        {{$izdavac->Naziv}}
                    </option>
            ...
            <div class="mt-[20px]">
                ...
                <select
                    ...
                    <option ></option>
                    @for($i=1958;$i<=2050;$i++)
                    <option @php if($i==$knjiga->DatumIzdavanja):echo'selected'; endif; @endphp value="{{$i}}">
                        {{$i}}
                    </option>
                    @endfor
                </select>
                  ...
                  @error('brStranaEdit')@php echo "Broj strana knjige je obavezno polje"; @endphp @enderror
                            ...
                            <div class="mt-[20px]">
                                ...
                                <select name="pismo" class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]" name="pismoEdit" id="pismoEdit" onclick="clearErrorsPismoEdit()">
                                    ...
                                    <option
                                    @php if($knjiga->pismo->id==$pismo->id){ echo 'selected';
                    } @endphp
                                    value="{{$pismo->id}}">
                                        {{$pismo->Naziv}}
                                    </option>
                ...
                @error('pismo')@php echo "Pismo knjige je obavezno polje"; @endphp @enderror
                            ...
                            <div class="mt-[20px]">
                                ...
                                <select name="povez" class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]" name="povezEdit" id="povezEdit" onclick="clearErrorsPovezEdit()">
                                    ...
                                    <option
                                    @php if($knjiga->povez->id==$povez->id){ echo 'selected';
                    } @endphp
                                     value="{{$povez->id}}">
                                        {{$povez->Naziv}}
                                    </option>
                            ...
                            <div class="mt-[20px]">
                                ...
                                <select name="format" class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]" name="formatEdit" id="formatEdit" onclick="clearErrorsFormatEdit()">
                                    ...
                                    <option
                                    @php if($knjiga->format->id==$format->id){ echo 'selected';
                    } @endphp
                                     value="{{$format->id}}">
                                        {{$format->Naziv}}
                                    </option>
...
<div class="w-9/12 mx-auto bg-white rounded p7 mt-[40px] mb-[150px]">
                        <div x-data="dataFileDnD()"
                            ...
                            <div x-ref="dnd"
                                ...
                                <input accept="*" type="file" name="slika[]" multiple
                                ...
                                <div class="relative flex flex-col text-xs bg-white bg-opacity-50 hiddenImage1">
                                    ...
                                    <div
                                        class="absolute bottom-0 left-0 right-0 flex flex-col p-2 text-xs text-center bg-white bg-opacity-50">
                                                        <span
                                                            class="w-full font-bold text-gray-900 truncate">{{$slika->foto}}</span>
