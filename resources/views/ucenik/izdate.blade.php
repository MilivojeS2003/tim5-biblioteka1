                                    ...
                                    <div class="w-[300px] pl-[32px]">
                                        <span
                                            ...
                                            <div
                                                ...
                                                <a href="{{route('ucenik.vracene',$ucenik)}}" aria-label="Izdate knjige"
                                                    class="flex items-center">
                                                    <i
