...
@section('content')
    ...
    <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="heading">
                <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                        ...
                        <div>
                            <nav class="w-full rounded">
                                <ol class="flex list-reset">
                                    ...
                                    <li>
                                        <a href="{{route('ucenik.show',$ucenik)}}" class="text-[#2196f3] hover:text-blue-600">
                                            ID-{{$ucenik->id}}
                                        </a>
                                    </li>
                                </ol>
                    ...
                    <div class="pt-[24px] pr-[30px]">
                        ...
                        <a href="{{route('ucenik.edit',$ucenik)}}" class="hover:text-blue-600 inline ml-[20px] pr-[10px]">
            ...
            <div class="border-b-[1px] py-4 text-gray-500 border-[#e4dfdf] pl-[30px]">
                <a href="{{route('ucenik.show',$ucenik)}}" class="inline hover:text-blue-800">
                    Osnovni detalji
                </a>
                <a href="{{route('ucenik.izdate',$ucenik)}}" class="inline ml-[70px] active-book-nav">
                            ...
                            <div class="w-[300px] pl-[32px]">
                                <span class=" whitespace-nowrap w-full text-[25px]  flex justify-between fill-current">
                                    <div
                                        ...
                                        <a href="{{route('ucenik.izdate',$ucenik)}}" aria-label="Sve knjige" class="flex items-center">
                                            <i
                            ...
                            <div class="w-[300px] pl-[32px]">
                                <span class=" whitespace-nowrap w-full text-[25px] flex justify-between fill-current">
                                    <div
                                        ...
                                        <a href="{{route('ucenik.vracene',$ucenik)}}" aria-label="Vracene knjige"
                        ...
                        <li class="mb-[4px]">
                            <div class="w-[300px] pl-[28px]">
                                <span class=" whitespace-nowrap w-full text-[25px] flex justify-between fill-current">
                                    <div
                                        class="group hover:bg-[#EFF3F6] py-[15px] px-[20px] w-[268px] rounded-[10px] cursor-pointer">
                                        <a href="{{route('ucenik.prekoracenje',$ucenik)}}" aria-label="Knjige na raspolaganju"
                                            class="flex items-center">
                                            <i
                        ...
                        <li class="mb-[4px]">
                            <div class="w-[300px] pl-[32px]">
                                <span class=" whitespace-nowrap w-full text-[25px] flex justify-between fill-current">
                                    <div
                                        class="group hover:bg-[#EFF3F6] py-[15px] px-[20px] w-[268px] rounded-[10px] cursor-pointer">
                                        <a href="{{route('ucenik.aktivne',$ucenik)}}" aria-label="Rezervacije"
                                            class="flex items-center">
                                            <i
                        ...
                        @foreach($arhknjige as $k)
                            <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                ...
                                <td class="flex flex-row items-center px-4 py-3">
                                    ...
                                    <a href="{{route('knjiga.show',$k->knjiga)}}">
                                ...
                                {{date('d.m.Y',strtotime($k->datumrezervacije))}}
                                </td>
                                <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                                {{date('d.m.Y',strtotime($k->datumrezervacije.' +10 day'))}}
                                </td>
                                <td class="flex flex-row items-center px-4 py-3">
                                ...
                                @if($k->razlog_zatvaranja->Naziv=='Knjiga izdata')
                                <td class="px-4 py-3 text-sm leading-5 text-blue-900 whitespace-no-wrap">
                                    <div class="inline-block px-[6px] py-[2px] font-medium bg-green-200 rounded-[10px]">
                                        <span class="text-xs text-green-800">{{$k->razlog_zatvaranja->Naziv}}</span>
                                    </div>
                                </td>
                                @else 
                                <td class="px-4 py-3 text-sm leading-5 text-blue-900 whitespace-no-wrap">
                                    <div class="inline-block px-[6px] py-[2px] font-medium bg-red-200 rounded-[10px]">
                                        <span class="text-xs text-red-800">{{$k->razlog_zatvaranja->Naziv}}</span>
                                    </div>
                                </td>
                                @endif
                                <td class="px-4 py-3 text-sm leading-5 text-right whitespace-no-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                            ...
                                            role="menu">
                                            <div class="py-1">
                                                <a href="{{route('knjiga.show',$k->knjiga)}}" tabindex="0"
                                                    class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                    role="menuitem">
                                                ...
                                                <a href="{{route('knjiga.edit',$k->knjiga)}}" tabindex="0"
                                                    class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                    role="menuitem">
                                                ...
                                                <a href="{{route('knjiga.rezervacija',$k->knjiga)}}" tabindex="0"
                                                    class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                    role="menuitem">
                                                ...
                                                <a href="{{route('knjiga.vracanje',$k->knjiga)}}" tabindex="0"
                                                    class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                    role="menuitem">
                                                ...
                                                <a href="{{route('knjiga.otpis',$k->knjiga)}}" tabindex="0"
                                                    class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                    role="menuitem">
